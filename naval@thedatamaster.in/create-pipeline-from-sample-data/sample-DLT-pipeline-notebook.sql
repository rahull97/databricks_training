...
CREATE OR REFRESH STREAMING TABLE sales_orders_cleaned(
...
SELECT f.customer_id, f.customer_name, f.number_of_line_items, 
  ...
  FROM STREAM(sales_orders_raw) f
...
CREATE OR REFRESH MATERIALIZED VIEW sales_order_in_la
...
CREATE OR REFRESH MATERIALIZED VIEW sales_order_in_chicago
